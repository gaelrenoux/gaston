...
final class InputTranscription2(rawInput: InputModel) {
  ...
  lazy val problem: SmallProblem = SmallProblem(
    ...
    slotsToName = slotsNames,
    slotsToPersonsPresent = slotsPersonsPresent,
    slotsToNextSlot = slotsToNextSlot,
    slotsToMaxTopics = slotsMaxTopics,
    topicsCount = topicsCount,
    topicsToName = topics.topicsName,
    topicsToMandatories = topics.topicsMandatories,
    topicsToForbiddens = topics.topicsForbiddens,
    topicsToMinPersons = topics.topicsMin,
    topicsToMaxPersons = topics.topicsMax,
    topicsToAllowedSlots = topics.topicsAllowedSlots,
    topicsToFollowup = topics.topicsFollowup,
    topicsForced = topics.topicsForced,
    topicsToSimultaneous = constraints.topicsSimultaneous,
    topicsToNotSimultaneous = constraints.topicsNotSimultaneous,
    personsCount = personsCount,
    personsToName = personsName,
    personsToWeight = personsWeight,
