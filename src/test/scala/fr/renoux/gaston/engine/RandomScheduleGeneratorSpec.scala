...
import fr.renoux.gaston.input.{InputLoader, transcribe}
...
class RandomScheduleGeneratorSpec extends AnyFlatSpec with Matchers {
  ...
  "Generation on udocon 2017" should "work" in {
    implicit val uc2017: Problem = transcribe(InputLoader.fromClassPath("udocon2017/uc17-from-table.conf").force).force
